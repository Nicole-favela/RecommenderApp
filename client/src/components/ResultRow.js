...
export default function ResultRow({ title, movies, fetchUserList }) {
  ...
  return (
    <div className='result'>
      ...
      <div className='result__posters'>
        ...
        <DetailsModal open={open} handleClose={handleClose} movie={movies[index]} fetchUserList={fetchUserList} />
